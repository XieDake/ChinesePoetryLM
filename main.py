...
from data_helper import parseRawData,word2Id_id2Word,sent2Id,train_val_split
...
def parse_arguments():
    ...
    parse.add_argument('--lr', type=float, default=0.0011,help='initial learning rate')
    #
...
if(args.mode=="train"):
    for epoch in range(args.epochs):
        #train_val_split
        train_data_filter, val_data_filter=train_val_split(data_filter=data_filter)
        #train one epoch!
        ...
        #
        avg_val_loss=eval_after_one_epoch(model=model,data_filter_val=val_data_filter)
